    ...
    const createColorTitle = params => {
        return InfCreateClass({
            ...
            render: function() {
                ...
                return createVNode(2, 'span', null, [
                    createVNode(2, 'span', 'avoidCache-1', null, {
                        style: this.colorStyle()
                    }),
                    createVNode(2, 'span', null, '#' + this.state.hex)
                ]);
            }
        });
    };
    ...
    const createCompColor = config => {
        return InfCreateClass({
            ...
            render: function() {
                ...
                return createVNode(2, 'colorWrapp', null, [
                    createVNode(2, 'span', null, null, {
                        style: this.colorStyle()
                    }),
                    createVNode(2, 'span', 'mousetrap mousetrapColor', null, {
                        name: 'message'
                    })
                ]);
            }
